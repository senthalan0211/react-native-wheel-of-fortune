...
class WheelOfFortune extends Component {
  ...
  prepareWheel = () => {
    ...
    this.winner = this.props.options.winner
      ? this.props.options.winner >= 0?this.props.options.winner
      : Math.floor(Math.random() * this.numberOfSegments):Math.floor(Math.random() * this.numberOfSegments);
  ...
  render() {
    return (
      <View style={styles.spinWheelMainContainer}>
        {/* <View
          style={{
            // position: 'absolute',
            backgroundColor:'red',
          ...
          <View style={styles.wheelHanger}></View>
